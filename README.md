...
- 최신 릴리스: `v1.4.1`
- 최신 릴리스 태그: `v1.4.1` (`1a298ff`)
- 최초 기본 제품 완료 기준: `v1.4.0` (`178369b`)
- 실행 환경: Python 3.12 이상, Windows 작업 PC
- 저장소 공개 목적: 채용 포트폴리오 검토

프로젝트의 문제 정의와 설계 의도는 [PORTFOLIO.md](PORTFOLIO.md), 공개 점검 기록은 [docs/PUBLIC_READINESS.md](docs/PUBLIC_READINESS.md)에서 확인할 수 있습니다.

프로파일별 입력·판정·산출물·미지원 범위는 [docs/END_TO_END_SUPPORT_MATRIX.md](docs/END_TO_END_SUPPORT_MATRIX.md)에 정리했습니다.

합성 Windows Server 입력으로 생성한 실제 7개 산출물은 [examples/portfolio-preview/README.md](examples/portfolio-preview/README.md)에서 바로 확인할 수 있습니다. 배포 파일은 [v1.4.1 Release](https://github.com/ryuyunseong/kcii-audit-suite/releases/tag/v1.4.1)에 고정되어 있습니다.
...
- [포트폴리오 결과 미리보기](examples/portfolio-preview/README.md)
- [상세 Markdown 보고서](examples/portfolio-preview/generated/report.md)
- [보안 권고문](examples/portfolio-preview/generated/security_advisory.md)
- [상세결과 Excel](examples/portfolio-preview/generated/detail.xlsx)
- [통계 Excel](examples/portfolio-preview/generated/summary.xlsx)

미리보기는 저장소의 synthetic fixture를 실제 CLI에 입력해 생성했습니다. 실제 고객 증적이나 운영 환경 식별자는 포함하지 않습니다.
...
최신 `v1.4.1` Release 기준 전체 테스트는 `189 passed`였으며, wheel/sdist 빌드, checksum, clean wheel 설치와 프로파일별 smoke를 검증했습니다.
...
- `v1.4.1`과 이전 태그 및 Release asset은 변경하지 않습니다.
- 문서·작은 버그 수정은 `dev/v1.4.2`에서 관리합니다.
